...
#import "DBCKeychain.h"
#import "DBLog.h"
#import "MPOAuthCredentialConcreteStore.h"
#import "MPOAuthSignatureParameter.h"

NSString *kDBCSDKVersion = @"1.3.13"; // TODO: parameterize from build system

NSString *kDBCDropboxAPIHost = @"api.dropbox.com";
NSString *kDBCDropboxAPIContentHost = @"api-content.dropbox.com";
NSString *kDBCDropboxWebHost = @"www.dropbox.com";
NSString *kDBCDropboxAPIVersion = @"1";

NSString *kDBCRootDropbox = @"dropbox";
NSString *kDBCRootAppFolder = @"sandbox";

NSString *kDBCProtocolHTTPS = @"https";

NSString *kDBDropboxUnknownUserId = @"unknown";

static DBCSession *_sharedSession = nil;
...
- (id)initWithAppKey:(NSString *)key appSecret:(NSString *)secret root:(NSString *)theRoot {
    if ((self = [super init])) {
        ...
        NSDictionary *savedCredentials = [DBCKeychain credentials];
...
- (void)saveCredentials {
    ...
    [DBCKeychain setCredentials:credentials];
}
