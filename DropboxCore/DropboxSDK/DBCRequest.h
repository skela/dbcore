...
/*  This constructor downloads the URL into the resultData object if startImmediately is YES */
...
/*  Starts the request, only useful if startImmediately was NO. */
- (void)start;
